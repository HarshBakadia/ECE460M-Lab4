...
#set_property PACKAGE_PIN W16 [get_ports {pulse_mod[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {pulse_mod[0]}]
#set_property PACKAGE_PIN W17 [get_ports {pulse_mod[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {pulse_mod[1]}]
...
#set_property PACKAGE_PIN P1 [get_ports {t_sec_counter[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {t_sec_counter[0]}]
#set_property PACKAGE_PIN L1 [get_ports {t_sec_counter[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {t_sec_counter[1]}]
...
#set_property PACKAGE_PIN U2 [get_ports {dspl_sel[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {dspl_sel[0]}]
#set_property PACKAGE_PIN U4 [get_ports {dspl_sel[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {dspl_sel[1]}]
#set_property PACKAGE_PIN V4 [get_ports {dspl_sel[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {dspl_sel[2]}]
#set_property PACKAGE_PIN W4 [get_ports {dspl_sel[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {dspl_sel[3]}]
